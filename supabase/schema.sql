...
BEGIN
  INSERT INTO public.categories (user_id, name, icon, color, type, is_system) VALUES
    ...
    (p_user_id, 'Subscriptions',  '📱', '#06b6d4', 'expense', TRUE),
    (p_user_id, 'Utilities',      '⚡', '#eab308', 'expense', TRUE),
    (p_user_id, 'Travel',         '✈️', '#14b8a6', 'expense', TRUE),
    (p_user_id, 'Education',      '📚', '#f97316', 'expense', TRUE),
    (p_user_id, 'Savings',        '🏦', '#22c55e', 'expense', TRUE),
    (p_user_id, 'Investments',    '📈', '#10b981', 'expense', TRUE),
